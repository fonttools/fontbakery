...
class CheckerTest(unittest.TestCase):
    ...
    def test_results_nbsp_success(self):
        ...
        self.assertInSuccess('test_nbsp', run_set(p, 'result', 'test_nbsp'))

    def test_results_nbsp_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold!.ttf')
        self.assertInFailure('test_nbsp', run_set(p, 'result', 'test_nbsp'))

    def test_result_space_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_space', run_set(p, 'result', 'test_space'))

    def test_result_space_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Light!.ttf')
        self.assertInFailure('test_space', run_set(p, 'result', 'test_space'))

    def test_result_space_and_nbsp_has_same_advanced_width_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_nbsp_and_space_glyphs_width', run_set(p, 'result', 'test_nbsp_and_space_glyphs_width'))

    def test_result_space_and_nbsp_has_same_advanced_width_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold!.ttf')
        self.assertInFailure('test_nbsp_and_space_glyphs_width', run_set(p, 'result', 'test_nbsp_and_space_glyphs_width'))

    def test_result_METADATA_family_equals_to_binfont_familyname_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_family', run_set(p, 'result', 'test_metadata_family'))

    def test_result_METADATA_family_equals_to_binfont_familyname_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold!.ttf')
        self.assertInFailure('test_metadata_family', run_set(p, 'result', 'test_metadata_family'))

    def test_result_METADATA_postScriptName_canonical_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_postScriptName_canonical', run_set(p, 'result', 'test_metadata_postScriptName_canonical'))

    def test_result_METADATA_style_matches_postScriptName_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_style_matches_postScriptName', run_set(p, 'result', 'test_metadata_style_matches_postScriptName'))

    def test_result_METADATA_filename_matches_postScriptName_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_filename_matches_postScriptName', run_set(p, 'result', 'test_metadata_filename_matches_postScriptName'))

    def test_result_METADATA_fullname_matches_postScriptName_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_fullname_matches_postScriptName', run_set(p, 'result', 'test_metadata_fullname_matches_postScriptName'))

    def test_result_METADATA_postScriptName_matches_font_filename_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_postScriptName_matches_font_filename', run_set(p, 'result', 'test_metadata_postScriptName_matches_font_filename'))

    def test_result_METADATA_postScriptName_matches_internal_fontname_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_postScriptName_matches_internal_fontname', run_set(p, 'result', 'test_metadata_postScriptName_matches_internal_fontname'))

    def test_result_METADATA_style_value_matches_font_italicAngle_value_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_style_value_matches_font_italicAngle_value', run_set(p, 'result', 'test_metadata_style_value_matches_font_italicAngle_value'))

    def test_result_font_italicangle_is_zero_or_negative_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInSuccess('test_font_italicangle_is_zero_or_negative', run_set(p, 'result', 'test_font_italicangle_is_zero_or_negative'))

    def test_result_font_italicangle_is_zero_or_negative_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic!.ttf')
        self.assertInFailure('test_font_italicangle_is_zero_or_negative', run_set(p, 'result', 'test_font_italicangle_is_zero_or_negative'))

    def test_result_menu_file_exists_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInSuccess('test_menu_file_exists', run_set(p, 'result', 'test_menu_file_exists'))

    def test_result_menu_file_exists_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic!.ttf')
        self.assertInFailure('test_menu_file_exists', run_set(p, 'result', 'test_menu_file_exists'))

    def test_result_font_is_font_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInSuccess('test_font_is_font', run_set(p, 'result', 'test_font_is_font'))

    def test_result_METADATA_font_filename_canonical_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_font_filename_canonical', run_set(p, 'result', 'test_metadata_font_filename_canonical'))

    def test_result_metadata_fullname_is_equal_to_internal_font_fullname_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInSuccess('test_metadata_fullname_is_equal_to_internal_font_fullname', run_set(p, 'result', 'test_metadata_fullname_is_equal_to_internal_font_fullname'))

    def test_result_metadata_fullname_is_equal_to_internal_font_fullname_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic!.ttf')
        self.assertInFailure('test_metadata_fullname_is_equal_to_internal_font_fullname', run_set(p, 'result', 'test_metadata_fullname_is_equal_to_internal_font_fullname'))

    def test_result_menu_have_chars_for_family_key_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInSuccess('test_menu_have_chars_for_family_key', run_set(p, 'result', 'test_menu_have_chars_for_family_key'))

    def test_result_menu_have_chars_for_family_key_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInFailure('test_menu_have_chars_for_family_key', run_set(p, 'result', 'test_menu_have_chars_for_family_key'))

    def test_result_font_subsets_exists_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_font_subsets_exists', run_set(p, 'result', 'test_font_subsets_exists'))

    def test_result_font_subsets_exists_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold!.ttf')
        self.assertInFailure('test_font_subsets_exists', run_set(p, 'result', 'test_font_subsets_exists'))

    def test_result_metadata_family_matches_font_filenames_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_family_matches_font_filenames', run_set(p, 'result', 'test_metadata_family_matches_font_filenames'))

    def test_result_metadata_family_matches_font_filenames_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold!.ttf')
        self.assertInFailure('test_metadata_family_matches_font_filenames', run_set(p, 'result', 'test_metadata_family_matches_font_filenames'))

    def test_result_metadata_value_match_font_weight_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_value_match_font_weight', run_set(p, 'result', 'test_metadata_value_match_font_weight'))

    def test_result_metadata_value_match_font_weight_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInFailure('test_metadata_value_match_font_weight', run_set(p, 'result', 'test_metadata_value_match_font_weight'))

    def test_result_metadata_family_values_are_all_the_same(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_family_values_are_all_the_same', run_set(p, 'result', 'test_metadata_family_values_are_all_the_same'))
    ...
    def test_result_font_italic_style_matches_internal_font_properties_values_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInSuccess('test_font_italic_style_matches_internal_font_properties_values', run_set(p, 'result', 'test_font_italic_style_matches_internal_font_properties_values'))

    def test_result_font_normal_style_matches_internal_font_properties_values_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_font_normal_style_matches_internal_font_properties_values', run_set(p, 'result', 'test_font_normal_style_matches_internal_font_properties_values'))

    def test_result_subset_file_smaller_font_file_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_subset_file_smaller_font_file', run_set(p, 'result', 'test_subset_file_smaller_font_file'))

    def test_result_subset_file_smaller_font_file_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Light!.ttf')
        self.assertInFailure('test_subset_file_smaller_font_file', run_set(p, 'result', 'test_subset_file_smaller_font_file'))

    def test_result_metadata_family_matches_fullname_psname_family_part_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_family_matches_fullname_psname_family_part', run_set(p, 'result', 'test_metadata_family_matches_fullname_psname_family_part'))

    def test_result_metadata_weight_in_range_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_weight_in_range', run_set(p, 'result', 'test_metadata_weight_in_range'))

    def test_result_metadata_weight_in_range_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Regular.ttf')
        self.assertInFailure('test_metadata_weight_in_range', run_set(p, 'result', 'test_metadata_weight_in_range'))

    def test_result_font_has_dsig_table_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Regular.ttf')
        self.assertInSuccess('test_font_has_dsig_table', run_set(p, 'result', 'test_font_has_dsig_table'))

    def test_result_font_has_dsig_table_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold!.ttf')
        self.assertInFailure('test_font_has_dsig_table', run_set(p, 'result', 'test_font_has_dsig_table'))

    def test_result_license_url_is_included_and_correct_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Regular.ttf')
        self.assertInSuccess('test_license_url_is_included_and_correct', run_set(p, 'result', 'test_license_url_is_included_and_correct'))

    def test_result_license_url_is_included_and_correct_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold!.ttf')
        self.assertInFailure('test_license_url_is_included_and_correct', run_set(p, 'result', 'test_license_url_is_included_and_correct'))
    ...
    def test_result_is_fsType_not_set_failure(self):
        # TODO: create XXX_success test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Light!.ttf')
        self.assertInFailure('test_is_fsType_not_set', run_set(p, 'result', 'test_is_fsType_not_set'))

    def test_result_metadata_copyrights_are_equal_for_all_fonts_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_copyrights_are_equal_for_all_fonts', run_set(p, 'result', 'test_metadata_copyrights_are_equal_for_all_fonts'))

    def test_result_metadata_copyright_matches_pattern_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_copyright_matches_pattern', run_set(p, 'result', 'test_metadata_copyright_matches_pattern'))

    def test_result_metadata_copyright_contains_rfn_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_copyright_contains_rfn', run_set(p, 'result', 'test_metadata_copyright_contains_rfn'))
    ...
    def test_result_metadata_has_unique_style_weight_pairs_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_metadata_has_unique_style_weight_pairs', run_set(p, 'result', 'test_metadata_has_unique_style_weight_pairs'))

    def test_result_macintosh_platform_names_matches_windows_platform_success(self):
        # TODO: create XXX_failure test
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_macintosh_platform_names_matches_windows_platform', run_set(p, 'result', 'test_macintosh_platform_names_matches_windows_platform'))

    def test_result_prep_magic_code_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_prep_magic_code', run_set(p, 'result', 'test_prep_magic_code'))

    def test_result_prep_magic_code_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInFailure('test_prep_magic_code', run_set(p, 'result', 'test_prep_magic_code'))

    def test_result_table_gasp_type_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_table_gasp_type', run_set(p, 'result', 'test_table_gasp_type'))

    def test_result_table_gasp_type_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInFailure('test_table_gasp_type', run_set(p, 'result', 'test_table_gasp_type'))

    def test_result_no_kern_table_exists_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInSuccess('test_no_kern_table_exists', run_set(p, 'result', 'test_no_kern_table_exists'))

    def test_result_no_kern_table_exists_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold!.ttf')
        self.assertInFailure('test_no_kern_table_exists', run_set(p, 'result', 'test_no_kern_table_exists'))

    def test_result_font_gpos_table_has_kerning_info_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Light.ttf')
        self.assertInSuccess('test_font_gpos_table_has_kerning_info', run_set(p, 'result', 'test_font_gpos_table_has_kerning_info'))

    def test_result_font_gpos_table_has_kerning_info_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInFailure('test_font_gpos_table_has_kerning_info', run_set(p, 'result', 'test_font_gpos_table_has_kerning_info'))

    def test_result_camelcase_in_fontname_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInFailure('test_camelcase_in_fontname', run_set(p, 'result', 'test_camelcase_in_fontname'))

    def test_result_family_is_listed_in_gwf_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInFailure('test_family_is_listed_in_gwf', run_set(p, 'result', 'test_family_is_listed_in_gwf'))

    def test_result_metadata_regular_is_400_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInFailure('test_metadata_regular_is_400', run_set(p, 'result', 'test_metadata_regular_is_400'))

    def test_result_em_is_1000_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInSuccess('test_em_is_1000', run_set(p, 'result', 'test_em_is_1000'))

    def test_result_em_is_1000_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Bold.ttf')
        self.assertInFailure('test_em_is_1000', run_set(p, 'result', 'test_em_is_1000'))

    def test_result_metrics_maximum_advanced_width_in_hhea_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInSuccess('test_metrics_maximum_advanced_width_in_hhea', run_set(p, 'result', 'test_metrics_maximum_advanced_width_in_hhea'))

    def test_result_metrics_advance_width_in_glyphs_same_if_monospace_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInSuccess('test_metrics_advance_width_in_glyphs_same_if_monospace', run_set(p, 'result', 'test_metrics_advance_width_in_glyphs_same_if_monospace'))

    def test_result_metadata_weight_matches_postscriptname_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Italic.ttf')
        self.assertInSuccess('test_metadata_weight_matches_postscriptname', run_set(p, 'result', 'test_metadata_weight_matches_postscriptname'))

    def test_ttx_doesnt_contain_duplicate_glyphs_failure(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/src/Font-Bold.ttx')
        self.assertInFailure('test_ttx_doesnt_contain_duplicate_glyphs', run_set(p, 'upstream-ttx', 'test_ttx_doesnt_contain_duplicate_glyphs'))

    def test_ttx_doesnt_contain_duplicate_glyphs_success(self):
        p = op.join(app.config['ROOT'], 'tests/fixtures/src/Font-Bold!.ttx')
        self.assertInSuccess('test_ttx_doesnt_contain_duplicate_glyphs', run_set(p, 'upstream-ttx', 'test_ttx_doesnt_contain_duplicate_glyphs'))

    # TODO: create fixture to make test failure
    # def test_result_metrics_maximum_advanced_width_in_hhea_failure(self):
    #     p = op.join(app.config['ROOT'], 'tests/fixtures/ttf/Font-Regular.ttf')
    #     self.assertInFailure('test_metrics_maximum_advanced_width_in_hhea', run_set(p, 'result'))
