...
def test_check_ttx_roundtrip():
    ...
    check = CheckTester(universal_profile, "com.google.fonts/check/ttx-roundtrip")
...
def test_is_up_to_date():
    ...
    assert is_up_to_date(installed="0.5.0", latest="0.5.0") == True
    assert is_up_to_date(installed="0.5.1", latest="0.5.0") == True
    assert is_up_to_date(installed="0.4.1", latest="0.5.0") == False
    assert is_up_to_date(installed="0.3.4", latest="0.3.5") == False
    assert is_up_to_date(installed="1.0.0", latest="1.0.1") == False
    assert is_up_to_date(installed="2.0.0", latest="1.5.3") == True
    assert (
        is_up_to_date(installed="0.5.2.dev73+g8c9ebc0.d20181023", latest="0.5.1")
        == True
    )
    assert (
        is_up_to_date(installed="0.5.2.dev73+g8c9ebc0.d20181023", latest="0.5.2")
        == False
    )
    assert (
        is_up_to_date(installed="0.5.2.dev73+g8c9ebc0.d20181023", latest="0.5.3")
        == False
    )
...
def test_check_cjk_chws_feature():
    ...
    assert_results_contain(
        check(ttFont), FAIL, "missing-chws-feature", "for Source Han Sans"
    )

    assert_results_contain(
        check(ttFont), FAIL, "missing-vchw-feature", "for Source Han Sans"
    )
...
def test_check_designspace_has_sources():
    ...
    check = CheckTester(
        universal_profile, "com.google.fonts/check/designspace_has_sources"
    )
...
def test_check_designspace_has_default_master():
    ...
    check = CheckTester(
        universal_profile, "com.google.fonts/check/designspace_has_default_master"
    )
...
def test_check_designspace_has_consistent_glyphset():
    ...
    check = CheckTester(
        universal_profile, "com.google.fonts/check/designspace_has_consistent_glyphset"
    )
...
def test_check_dotted_circle():
    ...
    check = CheckTester(universal_profile, "com.google.fonts/check/dotted_circle")
...
def test_check_gpos7():
    ...
    assert_results_contain(check(font), FAIL, "has-gpos7")
