...
def com_google_fonts_check_whitespace_glyphnames(ttFont):
    ...
    AGL_RECOMMENDED_00A0 = {
        "uni00A0",
        "space",
    }  # "space" is in this set because some fonts
    ...
    if ttFont["post"].formatType == 3.0:
        ...
        if not space:
            passed = False
            yield FAIL, Message("missing-0020", "Glyph 0x0020 is missing a glyph name!")
        ...
        if not nbsp:
            yield FAIL, Message("missing-00a0", "Glyph 0x00A0 is missing a glyph name!")
