...
@check(
    ...
    rationale="""
        ...
        Then it checks the font for correct shaping behaviour for all languages in those glyphsets.
    """,
...
def com_google_fonts_check_glyphsets_shape_languages(ttFont):
    ...
    LANGUAGE_CODES_PER_GLYPHSET = {'GF_Arabic_Core': ['ar_Arab', 'fa_Arab', 'ur_Arab'], 'GF_Arabic_Plus': ['ku_Arab', 'ms_Arab', 'ps_Arab', 'sd_Arab', 'ug_Arab'], 'GF_Latin_Kernel': ['aa_Latn', 'asa_Latn', 'bbc_Latn', 'bem_Latn', 'bez_Latn', 'bik_Latn', 'bi_Latn', 'ceb_Latn', 'cgg_Latn', 'crs_Latn', 'dav_Latn', 'fj_Latn', 'gil_Latn', 'guz_Latn', 'hil_Latn', 'id_Latn', 'jam_Latn', 'kl_Latn', 'kde_Latn', 'rw_Latn', 'kln_Latn', 'kmb_Latn', 'kg_Latn', 'ksb_Latn', 'kj_Latn', 'la_Latn', 'lua_Latn', 'luo_Latn', 'mgh_Latn', 'min_Latn', 'nr_Latn', 'nd_Latn', 'ng_Latn', 'njo_Latn', 'nyn_Latn', 'pam_Latn', 'pon_Latn', 'rn_Latn', 'rwk_Latn', 'saq_Latn', 'seh_Latn', 'sn_Latn', 'snk_Latn', 'so_Latn', 'ss_Latn', 'sw_Latn', 'tpi_Latn', 'ts_Latn', 'tum_Latn', 'wbp_Latn', 'xh_Latn', 'xog_Latn', 'zu_Latn'], 'GF_Latin_Core': ['ace_Latn', 'af_Latn', 'an_Latn', 'ban_Latn', 'eu_Latn', 'bs_Latn', 'br_Latn', 'ca_Latn', 'ch_Latn', 'chk_Latn', 'kw_Latn', 'co_Latn', 'hr_Latn', 'cs_Latn', 'da_Latn', 'nl_Latn', 'en_Latn', 'fo_Latn', 'fil_Latn', 'fi_Latn', 'fr_Latn', 'fur_Latn', 'gl_Latn', 'lg_Latn', 'de_Latn', 'aln_Latn', 'haw_Latn', 'hu_Latn', 'is_Latn', 'ilo_Latn', 'smn_Latn', 'ga_Latn', 'it_Latn', 'jv_Latn', 'dyo_Latn', 'kea_Latn', 'krl_Latn', 'csb_Latn', 'kha_Latn', 'ltg_Latn', 'lij_Latn', 'lt_Latn', 'lmo_Latn', 'nds_Latn', 'dsb_Latn', 'smj_Latn', 'lb_Latn', 'vmw_Latn', 'mg_Latn', 'mt_Latn', 'gv_Latn', 'mi_Latn', 'mh_Latn', 'mer_Latn', 'moh_Latn', 'nap_Latn', 'niu_Latn', 'ny_Latn', 'oc_Latn', 'pau_Latn', 'pap_Latn', 'pcd_Latn', 'pl_Latn', 'pt_Latn', 'qu_Latn', 'ro_Latn', 'rm_Latn', 'sm_Latn', 'sg_Latn', 'sbp_Latn', 'sc_Latn', 'gd_Latn', 'sei_Latn', 'scn_Latn', 'szl_Latn', 'sk_Latn', 'sl_Latn', 'sma_Latn', 'st_Latn', 'es_Latn', 'srn_Latn', 'su_Latn', 'sv_Latn', 'gsw_Latn', 'ty_Latn', 'teo_Latn', 'tet_Latn', 'tiv_Latn', 'tkl_Latn', 'tn_Latn', 'tr_Latn', 'aoz_Latn', 'hsb_Latn', 'vec_Latn', 'vep_Latn', 'vro_Latn', 'wa_Latn', 'war_Latn', 'guc_Latn', 'cy_Latn', 'fy_Latn', 'wo_Latn', 'yao_Latn', 'yap_Latn', 'yua_Latn'], 'GF_Latin_Vietnamese': ['bin_Latn', 'ebu_Latn', 'kgp_Latn', 'kam_Latn', 'ki_Latn', 'umb_Latn', 'vi_Latn', 'wae_Latn', 'xav_Latn'], 'GF_Latin_African': ['abr_Latn', 'ada_Latn', 'agq_Latn', 'ksf_Latn', 'bm_Latn', 'bci_Latn', 'buc_Latn', 'fuq_Latn', 'dua_Latn', 'dyu_Latn', 'ebu_Latn', 'ee_Latn', 'ewo_Latn', 'fon_Latn', 'gaa_Latn', 'gwi_Latn', 'ha_Latn', 'kam_Latn', 'ki_Latn', 'kiu_Latn', 'kri_Latn', 'nmg_Latn', 'lkt_Latn', 'lag_Latn', 'ln_Latn', 'loz_Latn', 'lu_Latn', 'ffm_Latn', 'mas_Latn', 'men_Latn', 'mos_Latn', 'mua_Latn', 'nv_Latn', 'nnh_Latn', 'jgo_Latn', 'fuv_Latn', 'nus_Latn', 'nym_Latn', 'nzi_Latn', 'srr_Latn', 'sms_Latn', 'suk_Latn', 'sus_Latn', 'twq_Latn', 'tem_Latn', 'tvl_Latn', 'umb_Latn', 've_Latn', 'wls_Latn', 'wae_Latn', 'xav_Latn', 'yav_Latn', 'dje_Latn'], 'GF_Latin_Beyond': ['abr_Latn', 'ada_Latn', 'bss_Latn', 'ast_Latn', 'bci_Latn', 'bug_Latn', 'ebu_Latn', 'gaa_Latn', 'gag_Latn', 'gwi_Latn', 'kgp_Latn', 'kam_Latn', 'ki_Latn', 'kiu_Latn', 'kri_Latn', 'ln_Latn', 'loz_Latn', 'lu_Latn', 'mfv_Latn', 'knf_Latn', 'men_Latn', 'nv_Latn', 'se_Latn', 'nus_Latn', 'nym_Latn', 'nzi_Latn', 'sms_Latn', 'tvl_Latn', 'umb_Latn', 'wae_Latn', 'xav_Latn', 'yav_Latn'], 'GF_Cyrillic_Core': ['be_Cyrl', 'bs_Cyrl', 'bg_Cyrl', 'myv_Cyrl', 'kum_Cyrl', 'mk_Cyrl', 'mdf_Cyrl', 'ru_Cyrl', 'rue_Cyrl', 'sr_Cyrl', 'uk_Cyrl'], 'GF_Cyrillic_Plus': ['ady_Cyrl', 'az_Cyrl', 'ba_Cyrl', 'be_Cyrl', 'bs_Cyrl', 'bg_Cyrl', 'ce_Cyrl', 'cv_Cyrl', 'myv_Cyrl', 'inh_Cyrl', 'kbd_Cyrl', 'kk_Cyrl', 'kv_Cyrl', 'kum_Cyrl', 'ku_Cyrl', 'ky_Cyrl', 'lbe_Cyrl', 'mk_Cyrl', 'chm_Cyrl', 'mdf_Cyrl', 'mn_Cyrl', 'ru_Cyrl', 'rue_Cyrl', 'sr_Cyrl', 'tg_Cyrl', 'tt_Cyrl', 'tkr_Cyrl', 'udm_Cyrl', 'uk_Cyrl', 'ug_Cyrl', 'uz_Cyrl'], 'GF_Cyrillic_Pro': ['ady_Cyrl', 'az_Cyrl', 'ba_Cyrl', 'be_Cyrl', 'bs_Cyrl', 'bg_Cyrl', 'ce_Cyrl', 'cv_Cyrl', 'myv_Cyrl', 'inh_Cyrl', 'kbd_Cyrl', 'kk_Cyrl', 'kv_Cyrl', 'kum_Cyrl', 'ku_Cyrl', 'ky_Cyrl', 'lbe_Cyrl', 'mk_Cyrl', 'chm_Cyrl', 'mdf_Cyrl', 'mn_Cyrl', 'ru_Cyrl', 'rue_Cyrl', 'sr_Cyrl', 'tg_Cyrl', 'tt_Cyrl', 'tkr_Cyrl', 'udm_Cyrl', 'uk_Cyrl', 'ug_Cyrl', 'uz_Cyrl'], 'GF_Greek_Core': ['el_Grek']}
    glyphsets_fulfilled = glyph_data.glyphsets_fulfilled(ttFont)
    for glyphset in glyphsets_fulfilled:
        percentage_fulfilled = glyphsets_fulfilled[glyphset]
        if percentage_fulfilled > .8:
            ...
            for language_code in LANGUAGE_CODES_PER_GLYPHSET[glyphset]:
                ...
                if reporter.warns:
                    yield WARN,\
                        Message("warning-language-shaping",
                                    f"{glyphset}/{language_code} ({shaperglot_languages[language_code]['name']}): {reporter.warns}")
                if reporter.fails:
                    passed = False
                    yield FAIL,\
                        Message("failed-language-shaping",
                                    f"{glyphset}/{language_code} ({shaperglot_languages[language_code]['name']}): {reporter.fails}")

    if not any_glyphset_supported:
        yield FAIL,\
            Message("no-glyphset-supported",
