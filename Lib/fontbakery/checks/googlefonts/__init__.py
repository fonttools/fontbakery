...
# I know this is a mess, we will tidy this up later.
...
def com_google_fonts_check_family_equal_codepoint_coverage(ttFonts, config):
    ...
    from fontbakery.profiles.googlefonts_conditions import canonical_stylename
...
def com_google_fonts_check_glyph_coverage(
    ...
    import unicodedata2
    from fontbakery.profiles.googlefonts_conditions import get_glyphsets_fulfilled
...
def com_google_fonts_check_cjk_not_enough_glyphs(ttFont):
    ...
    from fontbakery.profiles.shared_conditions import get_cjk_glyphs
...
def com_google_fonts_check_metadata_has_tags(family_metadata):
    ...
    from fontbakery.profiles.googlefonts_conditions import gf_tags
...
def com_google_fonts_check_varfont_bold_wght_coord(ttFont, bold_wght_coord):
    ...
    instance.
    """
    from fontbakery.profiles.shared_conditions import wght_axis
