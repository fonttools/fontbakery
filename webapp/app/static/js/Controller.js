...
//        xhr.responseType = 'arraybuffer';
        ...
        xhr.onreadystatechange = function () {
            ...
            if(xhr.status !== 200)
                ...
                JQ('table tr td:first-child').filter(function() { return $(this).text().indexOf("ERROR") === 0; }).parent().css("color", "#C22");
                JQ('table tr td:first-child').filter(function() { return $(this).text().indexOf("WARNING") === 0; }).parent().css("color", "#22C");
                JQ('table tr td:first-child').filter(function() { return $(this).text().indexOf("SKIP") === 0; }).parent().css("color", "#AA4");
                JQ('table tr td:first-child').filter(function() { return $(this).text().indexOf("INFO") === 0; }).parent().css("color", "#AAF");
