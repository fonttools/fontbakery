    ...
    return {
      ...
      link: function (scope, elm, attrs, ngModel) {
        ...
        scope.$watch(function () {
          ...
          if (angular.isDefined(opts.autoHeight) && opts.autoHeight == true) {
              var newHeight = acee.getSession().getScreenLength() * acee.renderer.lineHeight + acee.renderer.scrollBar.getWidth();
              angular.element(elm[0]).height(newHeight.toString() + "px" );
          }
          acee.resize();
